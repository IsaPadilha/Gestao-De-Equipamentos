    ...
    while (true)
    {
        if (opcaoMenuPrincipal == "1")
        {
            ...
            if (opcaoMenu == "1")
                ...
                telaEquipamento.VizualizarTodos();
        }
        ...
        else if (opcaoMenuPrincipal == "2")
        {
            ...
            if (opcaoMenu == "1")
            {
                ...
                {
                    Equipamentos eq = telaEquipamento.equipamentosSalvos[i];
            ...
            else if (opcaoMenu == "2")
            {
                ...
                for (int i = 0; i < chamadosSalvos.Length; i++)
                {
                    ...
                    if (chamadoSelecionado.id == idSelecionado)
                    {
                        ...
                        chamadoSelecionado.equipamentos = equipamentoSelecionado;
                        break;
                    }
                }
            ...
            {
                Console.WriteLine("---------------------------------");
                Console.WriteLine("Exclução de Chamados");
                Console.WriteLine("---------------------------------");
